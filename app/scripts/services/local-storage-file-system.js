(function () {
  ...
  angular.module('fs')
    ...
    .factory('localStorageFileSystem', localStorageFileSystemFactory)
    .config(function(fileSystemProvider) {
      if (!fileSystemProvider.hasFactory) { fileSystemProvider.setFileSystemFactory(localStorageFileSystemFactory); }
    });
})();
