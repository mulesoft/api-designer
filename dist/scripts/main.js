...
(function () {
  ...
  angular.module('ramlEditorApp').service('importService', [
    '$q',
    'ramlRepository',
    function importServiceFactory($q, ramlRepository) {
      var self = this;
      /**
